...
function print_table($entrepreneurs) {
    ...
    foreach ($entrepreneurs as $entrepreneur) {
        $htmlTable .= "<tr>
                    <td>{$entrepreneur->getFullName()}</td>
                    <td>{$entrepreneur->getTaxAmount()}</td>
                    <td>{$entrepreneur->getAddress()}</td>
                    <td>{$entrepreneur->getCity()}</td>
                    <td>{$entrepreneur->getRegistrationDate()}</td>
                    <td>{$entrepreneur->getServiceArea()}</td>
                </tr>";
    }
